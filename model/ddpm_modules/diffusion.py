...
class GaussianDiffusion(nn.Module):
    ...
    def p_sample_loop(self, x_in, nsample, continous=False):
        ...
        if continous:
            ...
            return code_stack[-1], deform, flow_stack
